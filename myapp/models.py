...
class Products(models.Model):
    ...
    supplier = models.ForeignKey(Suppliers, models.DO_NOTHING, db_column='supplier_id', blank=True, null=True)
    category = models.ForeignKey(Categories, models.DO_NOTHING, db_column='category_id', blank=True, null=True)
...
class Orders(models.Model):
    ...
    customer = models.ForeignKey(Customers, models.DO_NOTHING, db_column='customer_id', blank=True, null=True)
    employee = models.ForeignKey(Employees, models.DO_NOTHING, db_column='employee_id', blank=True, null=True)
